jQuery(document).ready(function($) {
  ...
  $(window).scroll(function() {
      ...
      $('.home .site-main .widget_list-widget h3, .home .site-main .widget_testimonial-widget h3, .home .site-main .widget_skill-widget h3, .home .site-main .widget_text h3, .home .site-main .widget_animation_custom h3').each(function(){
      var imagePos = $(this).offset().top;
      ...
      $('.home .content-area .widget_text, .home .content-area .widget_animation_custom').each(function(){
      var imagePos = $(this).offset().top;
